...
def compute_loss(output, reports_ids, reports_masks, labels=None, vis_label=None, txt_label=None,
                 z_img=None, z_txt=None, args={}, similarity_function='cosine'):
    #print(output.shape)
    ...
    if args.rank_loss:
        ...
        #print(labels)
    #print(match_loss)
    return loss + 0.1 * label_loss + 0.1 * match_loss#match_loss使用三元组边缘损失，label_loss使用二元交叉熵损失
...
class RankingLoss(nn.Module):
    ...
    def imposter_img_loss(self, z_image, z_text, labels, similarity_function):
        ...
        for i in range(batch_size):
            ...
            diff_similarity = F.relu(imposter_similarity - paired_similarity + margin)
