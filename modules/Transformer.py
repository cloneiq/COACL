...
class EncoderDecoder(nn.Module):
    ...
    def encode(self, src, src_mask):
        #print(self.encoder(self.src_embed(src), src_mask))
        return self.encoder(self.src_embed(src), src_mask)

    def decode(self, memory, src_mask, tgt, tgt_mask):
        #print(memory.shape)#torch.Size([8, 211, 512])
...
class TransformerModel(AttModel):
    ...
    def _prepare_feature_forward(self, att_feats, att_masks=None, seq=None):
        ...
        # embed att_features
        #print(att_feats.shape)#torch.Size([16, 112, 2048])
        ...
        #print(att_masks.shape)#torch.Size([16, 1, 112])
        # get seq_masks
        if seq is not None:
            # crop the last one
            # seq = seq[:,:-1]
            ...
            #print(subsequent_mask(seq.size(-1)).to(seq_mask))
    ...
    def _forward(self, fc_feats, att_feats, seq, att_masks=None):
        ...
        # decoder output
        #print(att_feats.shape)#torch.Size([16, 1, 112])
